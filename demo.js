...
const bodyB = HtmEBuilder.fromElement(document.body)
    ...
    .on(
        ...
        "click-on-body" // Id of listener, use when remove ex: bodyB.rmOn('click', 'click-on-body')
    );
...
const headerB = new HtmEBuilder("header")
    ...
    .append(openBtnB.el)
    .append(
        new HtmEBuilder("h2").append(
            new HtmEBuilder("a").href("./demo.html").text("Header").style({
                color: "white",
                textDecoration: "none",
            }).el
        ).el
